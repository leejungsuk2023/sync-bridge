...
client-web/app/api/messaging/    # 다이렉트 메시징 API (config, generate, upload-csv) + auto-reply (Korean Diet AI 챗봇 엔진, LINE webhook 수신 후 자동 답변) + suggest-reply (채널 대화용 AI 답변 추천, hospital_procedures/promotions/info 컨텍스트 포함)
...
client-web/vercel.json           # Vercel Cron 스케줄 (zendesk/cron 일 2회, followup-summary 일 4회, poll 일 4회, rag/index 일 1회 02:00 UTC, rag/index-koreandiet 일 1회 03:00 UTC, followup-check 일 1회 01:30 UTC)
